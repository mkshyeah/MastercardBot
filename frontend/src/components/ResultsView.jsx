      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center lg:items-start gap-10">
        ...
        <div className="flex-1 flex justify-center lg:justify-end w-full">
          <div className="w-full max-w-[520px] rounded-3xl bg-[#dde7f5] px-6 py-8 flex flex-col items-center gap-4">
            ...
            {loading && (
              <div className="w-full flex justify-center items-center bg-white rounded-xl shadow p-4">
                <Spinner />
            ...
            {error && (
              <div className="w-full bg-red-100 text-red-800 rounded-xl shadow p-4 text-sm">
                {error}
              </div>
            )}
            {backendResponse && (
